...
<head>
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
     ...
     <link type="text/css" href="https://cdn.datatables.net/1.10.19/css/jquery.dataTables.min.css"></link>
...
<body>
	...
	<div class="container">
		<a onclick="addData()" class="btn btn-success text-white" style="float: right">Add Post</a>
    ...
    <script type="text/javascript">
      ...
      //Insert data by Ajax
       ...
       function showData(id) {
        ...
        //delete single data ajax part here
